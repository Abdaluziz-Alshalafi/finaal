                                ...
                                @forelse($item->requests as $request)
                                    <div class="student-item">
                                        ...
                                        <div>
                                            ...
                                            <div class="person-info">{{ $request->student->id ?? 'غير معروف' }}</div>
                                        </div>
                                    </div>
                                @empty
            ...
            <div class="modal-body">
                <form id="researchForm">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="sub1">عنوان البحث</label>
                        <input type="text" class="form-input" id="sub1" name="sub1" placeholder="أدخل عنوان البحث" required>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch(`/student/research/${id}/edit`)
            ...
            .then(data => {
                ...
                if (data.topics && data.topics.length > 0) {
                    document.getElementById('sub1').value = data.topics[0].sub1 || '';
    ...
    // عرض رسالة إشعار
    function showToast(sub1, message, type = 'success') {
        const toast = document.getElementById('toast');
        const toastTitle = toast.querySelector('.toast-title');
        const toastMessage = document.getElementById('toastMessage');
        const toastIcon = toast.querySelector('.toast-icon i');

        toastTitle.textContent = sub1;
