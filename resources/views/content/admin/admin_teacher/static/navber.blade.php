<aside class="sidebar">
    ...
    <div class="user-profile">
      ...
      $departName = $admin->depart->depart_name ?? 'غير معروف';
       @endphp
      <div class="user-info">
        <h3>  مرحباً بك، {{$admin->name;}}</h3>
         <p> مشرف  {{$departName}}  </p>
    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li class="">
         <a>
            {{-- <a href="{{ route('show_student_project_admin') }}"> --}}
        ...
        <li class="{{ Route::currentRouteName() == 'show_student_project_admin' ? 'active' : '' }}">
          <a href="{{ route('show_student_project_admin') }}"><i class="fas fa-users"></i> إدارة الفريق</a>
        </li>
        <li>
