...
.swal2-arabic .swal2-actions {
    ...
    gap: 10px;
     ...
     <a href="{{ route('dean.manage.teams') }}" class="btn btn-primary">ادارة الفريق</a>
 <div class="container">
            ...
            <div class="project-card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="project-title m-0">
                        <i class="fas fa-project-diagram"></i>الفريق رقم: {{ $team_id }}
                    </h5>
